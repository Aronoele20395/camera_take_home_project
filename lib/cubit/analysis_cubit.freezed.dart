...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function()?  loading,TResult Function( AnalysisResult result)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function()  loading,required TResult Function( AnalysisResult result)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Idle():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function()?  loading,TResult? Function( AnalysisResult result)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
return idle();case _Loading() when loading != null:
return loading();case _Success() when success != null:
...
class _Idle implements AnalysisState {
  const _Idle();
...
class _Loading implements AnalysisState {
  const _Loading();
...
class _Success implements AnalysisState {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $AnalysisStateCopyWith<$Res> {
...
class _Error implements AnalysisState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AnalysisStateCopyWith<$Res> {
